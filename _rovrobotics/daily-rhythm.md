...
See also: [Sprint Rhythm]({{ '/rovrobotics/sprint-rhythm/' | relative_url }}) · [Sprint Calendar]({{ '/rovrobotics/sprint-calendar/' | relative_url }}) · [Why This Class Runs This Way]({{ '/rovrobotics/why-this-class-runs-this-way/' | relative_url }})
...
**Missing a 1-on-1 is a grade event.** See [Sprint Rhythm]({{ '/rovrobotics/sprint-rhythm/' | relative_url }}).
